function enviar(event) {
    ...
    let total = parseInt(document.getElementById("modelo")[document.getElementById("modelo").selectedIndex].value*1.07);
    lineamodelos.insertCell(3).innerHTML = formatter.format(total); 
    let subtotal = 0;
    ...
    subtotal = parseFloat(document.getElementById("color")[document.getElementById("color").selectedIndex].value*1.07);
    total +=subtotal;
    lineacolores.insertCell(3).innerHTML = formatter.format(subtotal);
    ...
    total += parseFloat(document.getElementById("potencia")[document.getElementById("potencia").selectedIndex].value*1.07);
...
window.onload = async function() {
    ...
    document.getElementById('precioM').value = modelos[0].Precio;
    document.getElementById('precioC').value = colores[0].Precio;
    document.getElementById('precioP').value = caballos[0].Precio;
...
function cambioModelo() {
      document.getElementById('precioM').value =modelos[document.getElementById("modelo").selectedIndex].Precio;
   
}
function cambioColor() {
  document.getElementById('precioC').value =colores[document.getElementById("color").selectedIndex].Precio;

}
function cambioPotencia() {
  document.getElementById('precioP').value =caballos[document.getElementById("potencia").selectedIndex].Precio;
